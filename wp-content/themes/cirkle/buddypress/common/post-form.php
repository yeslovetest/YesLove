...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" class="custom-class">
		    ...
		    <div class="tab-content">
		        <div class="tab-pane fade show active" id="post-status" role="tabpanel">
		            <div class="post-status-box">
				        <textarea class="bp-suggestions" name="whats-new" id="whats-new" placeholder="<?php esc_attr_e( 'Have you ever been in a
romantic relationship affected by a mood or a personality disorder? Why not
share your story to help others?
', 'cirkle' ); ?>" cols="50" rows="10" <?php if ( bp_is_group() ) : ?>data-suggestions-group-id="<?php echo esc_attr( (int) bp_get_current_group_id() ); ?>" <?php endif; ?>
		        ...
		        <div id="cirkle-whats-new-options">
					...
					<div class="submit-btn">
						<div id="whats-new-submit">
							<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php esc_attr_e( 'Post', 'cirkle' ); ?>" />
						</div>
					</div>
					<?php
					/**
