...
class FW_Db_Options_Model_Settings extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_settings_option( ?string $option_id, $value ) {
...
class FW_Db_Options_Model_Post extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param $value
		 */
		function fw_set_db_post_option( ?string $post_id, ?string $option_id, $value ) {
...
class FW_Db_Options_Model_Term extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @return null
		 */
		function fw_set_db_term_option( $term_id, $taxonomy, ?string $option_id, $value ) {
			if ( ! taxonomy_exists( $taxonomy ) ) {
				return null;
			}
...
class FW_Db_Options_Model_Extension extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_ext_settings_option( $extension_name, ?string $option_id, $value ) {
...
class FW_Db_Options_Model_Customizer extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_customizer_option( ?string $option_id, $value ) {
 ...
 */
{
	 ...
	 * @param mixed $value
	 */
	function fw_set_db_extension_data( $extension_name, ?string $multi_key, $value ) {
		if ( ! fw()->extensions->get( $extension_name ) ) {
			trigger_error( 'Invalid extension: ' . $extension_name, E_USER_WARNING );
