...
function gamipress_bp_activity_triggers( $triggers ) {
    ...
    if ( gamipress_bp_is_active( 'xprofile' ) ) {
        $triggers[__( 'BuddyPress Profile', 'gamipress-buddypress-integration' )] = array(
            ...
            'gamipress_bp_update_profile_any_value'         => __( 'Update profile field with any value', 'gamipress-buddypress-integration' ),
            'gamipress_bp_update_profile_specific_value'    => __( 'Update profile field with specific value', 'gamipress-buddypress-integration' ),
        );
    }
    ...
    if ( gamipress_bp_is_active( 'activity' ) ) {
        $triggers[__( 'BuddyPress Activity', 'gamipress-buddypress-integration' )] = array(
            ...
            'gamipress_bp_get_new_activity_comment'         => __( 'Get a reply on an activity post', 'gamipress-buddypress-integration' ),
            'gamipress_bp_delete_activity_comment'          => __( 'Delete a reply from an activity post', 'gamipress-buddypress-integration' ),
...
function gamipress_bp_activity_trigger_label( $title, $requirement_id, $requirement ) {
    ...
    switch( $requirement['trigger_type'] ) {
        ...
        case 'gamipress_bp_update_profile_specific_value':
            ...
            return sprintf( __( 'Update %s field with %s value', 'gamipress-buddypress-integration' ), $bp_field_name, $bp_field_value );
...
function gamipress_bp_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_bp_update_profile_any_value'] = __( 'Update %s field with any value', 'gamipress-buddypress-integration' );
    $specific_activity_trigger_labels['gamipress_bp_update_profile_specific_value'] = __( 'Update %s field with specific value', 'gamipress-buddypress-integration' );
