...
if( ! class_exists( 'GamiPress_Points_BP_Component' ) ) {
    ...
    class GamiPress_Points_BP_Component extends BP_Component {
        ...
        function __construct() {
            parent::start(
                'gamipress-points',
                __( 'GamiPress Points', 'gamipress-buddypress-integration' ),
                BP_PLUGIN_DIR
            );
        ...
        public function setup_globals( $args = '' ) {
            $points_tab_title = gamipress_bp_get_option( 'points_tab_title', __( 'Points', 'gamipress-buddypress-integration' ) );
        ...
        public function setup_nav( $main_nav = '', $sub_nav = '' ) {
            ...
            $tab_title = gamipress_bp_get_option( 'points_tab_title', __( 'Points', 'gamipress-buddypress-integration' ) );
