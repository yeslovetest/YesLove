...
function youzify_default_options() {
    ...
    $default_options = array(
        ...
        'youzify_wg_gamipress_user_badges_display_title' => 'on',
        'youzify_wg_gamipress_user_balance_display_title' => 'off',
        ...
        'youzify_wg_gamipress_user_balance_title' => __( 'Gamipress User Balance', 'youzify' ),
        ...
        'youzify_msgbox_google_map_api_key' => 'on',
...
function youzify_default_profile_cover() {
    ...
    if ( empty( $cover_path ) ) {
        $cover_path = apply_filters( 'youzify_user_profile_cover', '<div class="youzify-cover-pattern" style="background-image: url(' . youzify_get_default_profile_cover() . ');width: 100%; height: 100%; position: absolute;"></div>' );
    }
