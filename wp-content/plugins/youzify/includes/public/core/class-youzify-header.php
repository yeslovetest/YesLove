...
class Youzify_Header {
	...
	function get_header( $component ) {
		...
		<div class="youzify-header-cover">
			...
			<?php //if ( bp_is_my_profile() ) echo '<span class="youzify-open-upload-cover youzify-open-bp-uploader" data-type="cover"><i class="fas fa-image"></i>' . __( 'Change Cover', 'youzify' ) . '</span>'; ?>
