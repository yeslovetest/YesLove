...
function youzify_wall_settings() {
    ...
    // Get Captcha Url
    $tutorial_url = 'https://kainelabs.ticksy.com/article/19626/';

    $Youzify_Settings->get_field(
        array(
            'title'     => __( 'How to get your Google Map API Key?', 'youzify' ),
            'msg_type'  => 'info',
            'type'      => 'msgBox',
            'id'        => 'youzify_msgbox_google_map_api_key',
            'msg'       => sprintf( __( 'Please follow this tutorial on <strong><a href="%s">how to get Google Map API Key?</a></strong>', 'youzify' ), $tutorial_url )
        )
    );
    ...
    $Youzify_Settings->get_field(
        array(
            ...
            'desc'  => __( 'Enter Google Map API key', 'youzify' ),
        )
    );
    ...
    $Youzify_Settings->get_field(
        array(
            ...
            'desc'  => __( 'Keep it empty for all countries.', 'youzify' ),
